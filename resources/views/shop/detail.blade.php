                                    ...
                                    @if (count($product->galleryImages) > 0)
                                        @foreach ($product->galleryImages as $galleryImage)
                                            <div class="swiper-slide product-single__image-item">
                                                ...
                                                <a data-fancybox="gallery"
                                                    href="{{ asset('uploads/products/gallery/' . $galleryImage->image_path) }}"
                                                    data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <use href="#icon_zoom" />
                                    ...
                                    <div class="swiper-wrapper">
                                        @foreach ($product->galleryImages as $galleryImage)
                                            <div class="swiper-slide product-single__image-item"><img loading="lazy"
                                                    class="h-auto"
                                                    src="{{ asset('uploads/products/gallery/' . $galleryImage->image_path) }}"
                                                    width="104" height="104" alt="{{ $galleryImage->image_path }}" />
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
            ...
            "breakpoints": {
              ...
              "992": {
                ...
                "spaceBetween": 30
                                ...
                                <div class="swiper-slide product-card">
                                    <div class="pc__img-wrapper">
                                        <a href="{{ route('product.details', $relatedProduct->slug) }}">
                                            ...
                                            <img loading="lazy"
                                                src="{{ asset('uploads/products/thumbnails/' . $relatedProduct->image) }}"
                                                width="330" height="400" alt="{{ $relatedProduct->image }}"
                                                class="pc__img">
                                        </a>
                                        ...
                                        @else
                                            <form name="addtocart-form" method="POST" action="{{ route('cart.add') }}">
                                                ...
                                                <input type="hidden" name="title" value="{{ $relatedProduct->title }}">
                                                <input type="hidden" name="sale_price"
                                                    value="{{ $relatedProduct->sale_price }}">
                                                <button type="submit"
                                    ...
                                    <div class="pc__info position-relative">
                                        ...
                                        <h6 class="pc__title"><a
                                                href="{{ route('product.details', $relatedProduct->slug) }}">{{ $relatedProduct->title }}</a>
                                        </h6>
                                        <div class="product-card__price d-flex">
                                            <span class="money price">৳ {{ $relatedProduct->sale_price }}</span>
                                        </div>
                    ...
                    @else
                        <h4 class="text-center">{{ __('No Similar Product Found') }}</h4>
                    @endif
