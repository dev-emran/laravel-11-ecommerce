...
@section('content')
    <div class="main-content-inner">
        <div class="main-content-wrap">
            ...
            <!-- new-category -->
            <div class="wg-box">
                <form id="EditBrandFrom" class="form-new-product form-style-1" action="{{ route('category.update') }}"
                    ...
                    <fieldset class="name">
                        ...
                        <div class="w-full">
                            <input id="brandName" class="flex-grow d-block" type="text" placeholder="Brand name"
                                name="name" tabindex="0" value="{{ $category->name }}" aria-required="true">
                    ...
                    <fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            <div class="item" id="imgpreview" style="{{ $category->image ? '' : 'display:none' }}">
                                <img id="imgView" src="{{ asset('uploads/category') }}/{{ $category->image ?? '' }}"
                                    class="effect8" alt="">
                            </div>
