            ...
            <div class="wg-box">
                <form class="form-new-product form-style-1" action="{{ route('category.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <fieldset class="name">
                        ...
                        <div class="w-full">
                            <input id="cateName" class="flex-grow" type="text" placeholder="Category name" name="name"
                                tabindex="0" value="{{ old('name') }}" aria-required="true" required="">
                            <p id="cateNameErrDiv"></p>
                            @error('name')
                    ...
                    <fieldset class="name">
                        ...
                        <div class="w-full">
                            <input id="cateSlug" class="flex-grow" type="text" placeholder="Category Slug" name="slug"
                                tabindex="0" value="{{ old('slug') }}" aria-required="true" required="">
                            <p id="cateSlugErrDiv"></p>
                            @error('slug')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            <div class="item" id="imgpreview" style="display:none">
                                <img id="imgView" src="upload-1.html" class="effect8" alt="">
                            </div>
