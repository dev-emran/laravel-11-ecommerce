        ...
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                ...
                <div class="wg-table table-all-user">
                                        ...
                                        <td class="pname">
                                            <div class="image">
                                                <img src="{{ asset('uploads/category') }}/{{ $category->image ?? '' }}"
                                                    alt="{{ $category->name }}{{ __('_image') }}" class="image">
                                            </div>
                                            <div class="name">
                                        ...
                                        <td>
                                            <div class="list-icon-function">
                                                ...
                                                <div class="item text-danger delete">
                                                    <button style="background: transparent" form="cateDeleteForm"
                                                        onclick="return confirm('আপনি কি মুছে ফেলতে চান?')"><i
                                                            class="icon-trash-2"></i></button>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    <form id="cateDeleteForm" action="{{ route('category.delete') }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                    ...
                    @else
                        <h5 class="text-center text-warning py-5">{{ __('No categories found') }}</h5>
                    @endif
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="list-icon-function">
                                                    ...
                                                    <div class="item text-danger delete">
                                                        <button form="brandDeleteForm"
                                                            onclick="return confirm('Are You Sure?')"><i
                                                                class="icon-trash-2"></i></button>
                                                    </div>
                                                    <form id="brandDeleteForm" action="{{ route('brand.delete') }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
