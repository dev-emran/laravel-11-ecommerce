...
@section('content')
    <div class="main-content-inner">
        ...
        <div class="main-content-wrap">
            ...
            <!-- new-category -->
            <div class="wg-box">
                <form class="form-style-1" id="createSliderForm" method="POST" action="{{ route('slide.store') }}"
                    ...
                    <fieldset class="tagline">
                        ...
                        <div>
                            <input class="flex-grow" type="text" placeholder="Tag line" name="tagline" tabindex="0"
                                value="{{ old('tagline') }}" aria-required="true">
                            @error('tagline')
                                <em class="text-danger">{{ $message }}</em>
                            @enderror
                        </div>
                    ...
                    <fieldset class="subtitle">
                        ...
                        <div>
                            <input class="flex-grow" type="text" placeholder="Sub title" name="subtitle" tabindex="0"
                                value="{{ old('subtitle') }}" aria-required="true">
                            @error('subtitle')
                                <em class="text-danger">{{ $message }}</em>
                            @enderror
                        </div>
                    ...
                    <fieldset class="link">
                        ...
                        <div>
                            <input class="flex-grow" type="url" placeholder="Link" name="link" tabindex="0"
                                value="{{ old('link') }}" aria-required="true">
                            @error('link')
                                <em class="text-danger">{{ $message }}</em>
                            @enderror
                        </div>
                        ...
                        <div class="w-100">
                            <div class="upload-image flex-grow">
                                <div class="item" id="imgpreview" style="display:none">
                                    <img id="imgView" src="" class="effect8" alt="">
                                </div>
