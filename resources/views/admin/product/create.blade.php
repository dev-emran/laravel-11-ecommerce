...
@section('content')
    ...
    <div class="main-content-inner">
        ...
        <div class="main-content-wrap">
            ...
            <!-- form-add-product -->
            <form id="ProductForm" class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data"
                    ...
                    <fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            <div class="item" id="imgpreview" style="display:none">
                                <img id="imgView" src="" class="effect8"
                                    alt="">
                            </div>
                            ...
                            <div class="select mb-10">
                                <select class="" name="stock_status">
                                    ...
                                    <option value="outofstock"
                                        {{ old('stock_status') == 'outofstock' ? 'selected' : '' }}>Out of
                                        Stock
                                    </option>
                                </select>
                            </div>
